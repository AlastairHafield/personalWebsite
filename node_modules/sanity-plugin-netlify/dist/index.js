...
const DeployStatus = _ref => {
  ...
  var _a;
  const scheme = ui.usePrefersDark() ? "dark" : "light";
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
    ...
    children: [/* @__PURE__ */jsxRuntime.jsx(ui.Badge, {
    ...
    }), errorMessage && badgeStatus !== "CANCELED" && badgeStatus != "SKIPPED" && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
      marginLeft: 2,
      children: /* @__PURE__ */jsxRuntime.jsx(ui.Tooltip, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsx(icons.WarningOutlineIcon, {
          fontSize: 25,
          color: ui.studioTheme.color[scheme].critical.spot.red,
          style: {
            marginLeft: "2px"
          }
        })
...
const DeployHistory = _ref2 => {
  ...
  react.useEffect(() => {
    ...
    axios__default.default.get("https://api.netlify.com/api/v1/sites/".concat(siteId, "/deploys"), {
      headers: {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            ...
            children: /* @__PURE__ */jsxRuntime.jsx(ui.Text, {
              ...
              children: /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                ...
                children: deployment.commit_url && /* @__PURE__ */jsxRuntime.jsx("a", {
            ...
            children: /* @__PURE__ */jsxRuntime.jsx(ui.Inline, {
              ...
              children: /* @__PURE__ */jsxRuntime.jsx(ui.Text, {
                ...
                muted: true,
                children: spacetime__default.default.now().since(spacetime__default.default(deployment.created_at)).rounded
              })
            })
            ...
            }), deployment.state == "ready" && /* @__PURE__ */jsxRuntime.jsx("a", {
...
const fetcher = (url, accessToken, params) => axios__default.default.get(url, {
  headers: {
    "content-type": "application/json",
    Authorization: "Bearer ".concat(accessToken)
  },
...
const DeployItem = _ref4 => {
  ...
  const {
    data: deploymentData
  } = useSWR__default.default(() => ["https://api.netlify.com/api/v1/sites/".concat(siteId, "/deploys"), accessToken, deploymentDataParam], fetcher, {
    errorRetryCount: 3,
    refreshInterval: 1e3,
    onError: err => {
      var _a2, _b2, _c;
  ...
  const onDeploy = (_name, _url) => {
    ...
    axios__default.default.post(_url, options).then(() => {
      toast.push({
        status: "success",
        title: "Success!",
  ...
  const onCancel = (id, token) => {
    setIsLoading(true);
    axios__default.default.post("https://api.netlify.com/api/v1/deploys/".concat(id, "/cancel"), null, {
      headers: {
        "content-type": "application/json",
        Authorization: "Bearer ".concat(accessToken)
      }
      ...
      children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Inline, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            ...
            radius: 3,
            text: "Deploy"
          }), isDeploying && (status === "BUILDING" || status === "ENQUEUED" || status == "PREPARING" || status === "PROCESSING") && /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
            type: "button",
            tone: "critical",
            onClick: () => {
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(sanity.FormField, {
            ...
            description: /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: ["User dropdown \u2192 User settings \u2192 Applications \u2192\xA0", /* @__PURE__ */jsxRuntime.jsx("a", {
...
const NetlifyDeploy = () => {
  ...
  const onSubmit = async () => {
    client.create({
      ...
      _id: "netlify.".concat(nanoid.nanoid()),
      _type: WEBHOOK_TYPE,
      name: pendingDeploy.name,
      siteId: pendingDeploy.siteId,
      buildHook: pendingDeploy.buildHook,
...
const netlifyTool = sanity.definePlugin(options => {
  const {
    name,
    title,
    icon,
